        ...
        <Grid container spacing={6} alignItems="center">
          <Grid item xs={12} md={6}>
            <Box>
              ...
              <StyledDescription>
                At Innoblooms, we specialize in augmenting your resources with
                exceptional talent and innovative solutions. Our customized and
                breakthrough web applications are designed to seamlessly
                integrate with your business operations, empowering you to
                tackle challenges and achieve success with ease. Partner with us
                to take your business to new heights and emerge as a leader in
                your industry.{" "}
              </StyledDescription>
            </Box>
          </Grid>
