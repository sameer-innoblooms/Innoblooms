            ...
            <StyledSection>
              ...
              <Grid container spacing={4}  direction={isMobile? "column-reverse": "row"}>
                <Grid
                  ...
                  md={6}
                  sx={{
                    borderLeft: {md: "2px solid rgb(227, 227, 227)"},
                    borderBottom:  {md: "2px solid rgb(227, 227, 227)"}
                  }}
                >
                  <Typography
                    variant="h4"
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ position: "relative", height: 300,  mb: {xs: 1, sm: 2} }}>
                    <Image
            ...
            <StyledSection>
              ...
              <Grid container spacing={4}>
                <Grid
                  ...
                  md={6}
                  sx={{
                    borderRight:  {md: "2px solid rgb(227, 227, 227)"},
                    borderBottom:  {md: "2px solid rgb(227, 227, 227)"}
                  }}
                >
                ...
                <Grid item xs={12} md={6}>
                  <Typography
                    variant="h4"
                    sx={{ fontWeight: "bold", mb: 2, ml: 5, mt: {md: 11}, color: "#4A4A4A" }}
                  >
                    Design
                  </Typography>
                  <Typography
          ...
          <Grid item xs={12}>
            <StyledSection>
              ...
              <Grid container spacing={4}>
                ...
                >
                  <Box sx={{ position: "relative", height: 300, mb: {xs: 1, sm: 2, md: 10} }}>
                    <Image
